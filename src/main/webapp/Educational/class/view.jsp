    ...
    <form action="../../right.jsp" method="post">
	 <table border="1" width="100%" class="table_a">
                <tr>
                    ...
                    <td><input type="text" name="f_goods_name" value="术科系" /></td>
                </tr>
                <tr>
                    <td>班级编号：<span style="color:red">*</span>：</td>
                    <td>
                       <input type="text" name="f_goods_name" value="201602B" readonly /> 
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
						<input type="text" name="f_goods_price" value="2016春篮球" readonly/></td>
                </tr>
                <tr>
                    <td>人数：<span style="color:red">*</span>：</td>
                    <td>
						<input type="text" name="f_goods_price" value="2013-10-10" readonly/></td>
                </tr>
