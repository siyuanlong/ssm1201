 ...
 <div class="cztable">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <c:forEach items="${deploymentlist}" var="deployment">
                <tr align="center">
                    ...
                    <td><fmt:formatDate value="${deployment.deploymentTime}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
                    <td><a href="/bushu/deleteDeploy?did=${deployment.id}">删除</a></td>
                </tr>
            </c:forEach>
     ...
     <c:forEach items="${processdeflist}" var="process">
         <tr style="height: 25px" align="center">
             ...
             <th scope="col">${process.resourceName}</th>
             <th scope="col">${process.diagramResourceName}</th>
             <th scope="col">${process.deploymentId}</th>
             <th scope="col"><a href="/bushu/chakan?deploymentId=${process.deploymentId}
                                    &resourceName=${process.diagramResourceName}">查看流程图</a></th>
         </tr>
     </c:forEach>
         </tbody>
     </table>
     <hr>
     <form action="/bushu/add" method="post" enctype="multipart/form-data">
     <table>
         <tr>
