...
<div class="cztable">
    <form action="/power/menu/edit" method="post">
        <input type="hidden" name="menuid" value="${thismenu.menuid}"/>
        <table border="1" width="100%" class="table_a">
            <tr width="120px;">
                <td width="120px">资源菜单名：<span style="color:red">*</span>：</td>
                <td>
                    <input type="text" name="menuname" value="${thismenu.menuname}"/>
                </td>
            </tr>
                ...
                <td>
                    <select name="upmenuid">
                        <option value="-1">顶级菜单</option>
                            <c:if test="${thismenu.upmenuid!=-1 || size == 0}">
            ...
            <tr width="120px;">
                ...
                <td>
                    <input type="text" name="menupath" value="${thismenu.menupath}"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="menustate" ${thismenu.menustate==1?"checked":""} value="1"/>启用
                    <input type="radio" name="menustate" ${thismenu.menustate==2?"checked":""}value="0"/>禁用
                </td>
            </tr>
