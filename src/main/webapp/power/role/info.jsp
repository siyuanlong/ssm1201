...
<table border="1" width="100%" class="table_a">
                <tr  width="120px;">
                    ...
                    <td>
						<input type="text"  name="f_goods_image" value="${role1.rolename}" />
					</td>
                </tr>
                    ...
                    <td>
						<ul>
                        	...
                        	<li>
                                ...
                                <c:forEach items="${role1.menus}" var="mymenu">
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="state" ${role1.rolestate==1?"checked":""} value="1" />启用
                        <input type="radio" name="state" ${role1.rolestate!=1?"checked":""} value="0"/>禁用
                    </td>
                </tr>
