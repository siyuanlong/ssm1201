    ...
    <script type="text/javascript">
        ...
        function findinfo(size) {
            ...
            if (title==null || title=="" ){
                ...
                window.location.href = "/study/getinfo2?size="+size+"&title2="+title2;
            }
        }
        ...
        $(function () {
            $("#psize").change(function () {
                var size = $(this).val();
                alert(size);
                window.location.href = "/study/getinfo2?size="+size;
            })
        })
    </script>
</head>
    ...
    <div class="fllist">
        <ul>
            ...
            标题:&nbsp;&nbsp;
                ...
                <input id="inp" type="text" name="title2" />&nbsp;&nbsp;<input type="button" value="搜索" onclick="findinfo(${infopi2.pageSize})" />
            </li>
        ...
        <div class="cztable">
            <form action="/study/download" enctype="multipart/form-data" method="post">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                    ...
                    <c:forEach items="${infopi2.list}" var="info2">
                        <tr>
                            <td>
                            <img src='../Images/FileIco/doc.gif' />
                            </td>
                            <td class="xxleft">
                                ${info2.informationname}
                            </td>
                            <td>
                                ${info2.infotype.infotype}
                            </td>
                            <td>
                                <fmt:formatDate value="${info2.date}" pattern="yyyy-MM-dd"></fmt:formatDate>
                            </td>
                            <td>
                                <a href="/study/download?file=${info2.url}" target="_blank">
                    ...
                    <tr>
                        <td colspan="20" style="text-align: center;">
                            <p:page uri="/book/getinfo2" pageInfo="${infopi2}"></p:page>
                        </td>
                    </tr>
